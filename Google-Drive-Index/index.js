        ...
        const authConfig = {
            "siteName": "McRoyce's Google Drive", // Website name
            ...
            "refresh_token": "1//0eKldb9W5DFY-CgYIARAAGA4SNwF-L9Irjw_OISBEZVo2z_kZCkaBnpuJM6gvIm5IIe2ZDmtNFcJfoXOYo-jWndQk1ZBpfv9uW4Y", // Authorize token
        ...
        const uiConfig = {
            "theme": "vapor", // switch between themes, default set to slate, select from https://gitlab.com/GoogleDriveIndex/Google-Drive-Index
            ...
            "favicon": "https://i.pinimg.com/736x/9d/e3/d0/9de3d09b71ce6b316cb7f1209babaed4.jpg",
            // if logo is true then link otherwise just text for name
            "logo_link_name": "https://www.pngall.com/wp-content/uploads/9/Synthwave-PNG-Pic-Background.png",
        ...
        <body>
            ...
            <div>
                <div id="content" style="padding-top: ${uiConfig.header_padding}px;">
                    <div class="container">
                    <div class="alert alert-dismissible alert-primary d-flex align-items-center" role="alert" style="margin-bottom: 0; padding-bottom: 0rem;">
                    ...
                    <div class="login d-flex align-items-center py-5">
                        <div class="container">
                            <div class="row">
                                ...
                                <div id="error-message" class="alert alert-dismissible alert-danger"></div>
